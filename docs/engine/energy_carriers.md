...
All the datastructures, such as the [accumulators](data_structures/accumulators.md) in the rapidrundata, that store data for charts and graphs are dynamically extended to include these new energycarriers.
